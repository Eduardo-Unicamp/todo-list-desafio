...
public class TaskDTO {
    ...
    @NotEmpty(message = "cd o status paizao")
    private String title;

    private String description;

    @NotNull(message = "cd o status paizao")
    @FutureOrPresent(message = "cd o status paizao")
    ...
    @NotNull(message = "O valor para participants deve ser enviado. Use \"[]\" caso não hajam participantes.")//pode estar vazia mas nao nula
